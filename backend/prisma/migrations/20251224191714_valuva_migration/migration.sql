...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('CREDIT_CARD', 'DEBIT_CARD', 'UPI', 'NET_BANKING', 'WALLET', 'COD', 'SHOPIFY_PAYMENTS');

-- CreateEnum
CREATE TYPE "DiscountType" AS ENUM ('PERCENTAGE', 'FIXED_AMOUNT');

-- CreateEnum
CREATE TYPE "SectionType" AS ENUM ('HERO_BANNER', 'FEATURED_PRODUCTS', 'NEW_ARRIVALS', 'BEST_SELLERS', 'CATEGORY_SHOWCASE', 'BANNER', 'CUSTOM');
