...
class CheckoutService {
  ...
  async validateCart(user: any) {
    return { valid: true };
  }

  async getAddresses(user: any) {
    return [{ id: "addr-1", line1: "123" }];
  }
  async calculateShipping(user: any, body: any) {
    return { cost: 5.0, method: "standard" };
  }
  ...
  async selectShippingMethod(user: any, methodId: string) {
    return { selected: methodId };
  }
  async verifyAddress(user: any, body: any) {
    return { valid: true };
  }

  async getCoupons(user: any) {
    return [{ code: "SAVE5", discount: 5 }];
  }
  async applyCoupon(user: any, code: string) {
    return { code, discount: 5 };
  }
  async removeCoupon(user: any) {
    return;
  }
  async applyLoyalty(user: any, points: number) {
    return { applied: points };
  }

  async getPaymentMethods(user: any) {
    return [{ id: "pm-1", provider: "PayU" }];
  }
  async selectPaymentMethod(user: any, methodId: string) {
    return { selected: methodId };
  }
  async getSavedPayments(user: any) {
    return [];
  }
  async verifyPaymentEligibility(user: any) {
    return { eligible: true };
  }

  async finalSummary(user: any) {
    return { total: 100 };
  }
  async initiateCheckout(user: any, body: any) {
    return { checkoutId: crypto.randomUUID() };
  }
  async placeOrder(user: any, body: any) {
    return { orderId: crypto.randomUUID(), status: "placed" };
  }
  async verifyPayment(user: any, body: any) {
  ...
  async sendConfirmationEmail(id: string, email: string) {
    return;
  }

  async saveState(user: any, payload: any) {
    return { saved: true };
  }
  ...
  async deliveryEstimate(body: any) {
    return { days: 3 };
  }
  async checkCod(address: any) {
    return { codAvailable: true };
  }
  async taxBreakdown(user: any, body: any) {
    return { tax: 10 };
  }
  async applyGiftcard(user: any, code: string) {
    return { applied: code };
  }
  async removeGiftcard(user: any) {
    return;
  }

  async guestInitialize(body: any) {
    return { guestId: crypto.randomUUID() };
  }
  async guestPlaceOrder(body: any) {
    return { orderId: crypto.randomUUID() };
  }
  async guestTrack(id: string, email: string) {
    return { id, status: "in_transit" };
  }

  async saveCart(user: any, body: any) {
    return { savedId: crypto.randomUUID() };
  }
  async getAbandoned(query: any) {
    return [];
  }
