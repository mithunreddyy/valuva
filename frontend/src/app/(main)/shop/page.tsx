          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
              <div className="space-y-1.5 sm:space-y-2">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-medium tracking-normal text-[#0a0a0a]">
                  Shop
                </h1>
                {data && (
              ...
              <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                <ShopSort />
                {/* View Toggle */}
                <div className="hidden md:flex items-center border border-[#e5e5e5] rounded-[16px] overflow-hidden bg-white shadow-sm">
                  <button
                ...
                <div className="space-y-6">
                  {isLoading
                    ? Array.from({ length: limit }).map((_, i) => (
                        <div
                          key={i}
                          className="bg-white border border-[#e5e5e5] p-6 rounded-[20px] animate-pulse"
                        >
                          <div className="flex gap-6">
                            <div className="w-32 h-32 bg-[#e5e5e5] rounded-[16px]"></div>
                            <div className="flex-1 space-y-3">
                              <div className="h-6 bg-[#e5e5e5] w-3/4 rounded-[8px]"></div>
                              <div className="h-4 bg-[#e5e5e5] w-1/2 rounded-[8px]"></div>
                              <div className="h-4 bg-[#e5e5e5] w-2/3 rounded-[8px]"></div>
                            </div>
                          </div>
                        </div>
                      ))
