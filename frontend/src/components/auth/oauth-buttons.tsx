      ...
      <div className={`space-y-4 ${className}`}>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white px-3 text-xs sm:text-sm text-neutral-500 font-medium">
              Or continue with
            </span>
          </div>
        </div>
        ...
        {/* Error Message */}
        {error && (
          <div className="p-3 text-xs sm:text-sm text-red-600 bg-red-50 border border-red-200 rounded-[10px]">
            {error}
          </div>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-10 sm:h-11 text-sm font-medium bg-white border border-[#e5e5e5] hover:bg-[#fafafa] hover:border-[#0a0a0a] text-[#0a0a0a] rounded-[10px] transition-all disabled:opacity-50"
